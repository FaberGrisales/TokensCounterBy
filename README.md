...
**Cómo calculo "When Your Current Window Clears"**: en vez de adivinar "cuándo empezó tu sesión" (un intento anterior que resultaba engañoso — cualquier pausa de 5+ horas hacía que pareciera "recién empezada"), tomo tu petición real más reciente dentro de la ventana y calculo cuándo se saldría de esa ventana (petición + 5h o + 7 días). Es un cálculo directo sobre datos reales, no una suposición sobre "sesiones".
